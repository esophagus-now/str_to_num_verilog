...
set_property interface_mode master [ipx::get_bus_interfaces str -of_objects [ipx::current_core]]
...
set_property VALUE str [ipx::get_bus_parameters ASSOCIATED_BUSIF -of_objects [ipx::get_bus_interfaces clk -of_objects [ipx::current_core ]]]
